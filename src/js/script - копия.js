...
function commentControls() {
	var reply_markup = $(' \
			<dl class="reply reply-admin"> \
				<dt>Reply from restaurant or nightclub management or staff:</dt> \
				<dd> \
					<textarea></textarea>\
					<div class="buttons"> \
						<a href="" class="btn -green -small -wide" data-reply>Reply</a> \
						<a href="" class="btn -grey -small -wide" data-cancel>Cancel</a> \
					</div> \
				</dd>	\
			</dl>');
	...
	$('.comment').each(function() {
		var $this = $(this),
			controls = {
				answer: $this.find('[data-answer]'),
				edit: $this.find('[data-edit]'),
				remove: $this.find('[data-remove]')
		};

		controls.answer.click(function() {
			if (!$this.next('.reply').length) {
				var reply = reply_markup.clone().insertAfter($this),
					reply_btn = reply.find('[data-reply]'),
					cancel_btn = reply.find('[data-cancel]'),
					field = reply.find('textarea');
